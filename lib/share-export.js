...
function nextStepSpliceOf(event) {
 ...
 * be).
 */
function applyNextStepSplice(previous, splice) {
...
function foldRows(events) {
    const rows = [];
    let inbox = { pending: [], currentClaimed: NO_CLAIM };

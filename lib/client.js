...
function MobileHomeChipsSheetBody({ t }) {
    const prefs = (0, chips_store_ts_1.useChipsPrefs)();
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("div", { "data-mobile-nav": "home-sheet-title", children: t('chipCustomize') }), exports.CHIP_DEFS.map((def) => {

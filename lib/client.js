 ...
 */
exports.MOBILE_CSS = [base_css_ts_1.BASE_CSS, layout_css_ts_1.LAYOUT_CSS, compat_css_ts_1.COMPAT_CSS, misc_css_ts_1.MISC_CSS, home_css_ts_1.HOME_CSS, header_css_ts_1.HEADER_CSS, composer_css_ts_1.COMPOSER_CSS, info_css_ts_1.INFO_CSS, turn_fold_css_ts_1.TURN_FOLD_CSS].join('\n');
};
...
function installViewportHeal(ctx) {
    ctx.effect(() => {
        ...
        let failures = 0;
        const heal = () => {
            if (failures >= 3 || ceiling() - window.innerHeight <= 4)
                return;
            const frame = document.querySelector('[data-mobile-nav="frame"]');
            if (frame === null)
                return;
            ...
            if (ceiling() - window.innerHeight > 4)
                failures += 1;
            else
                failures = 0;
        };
            ...
            return [
                ...
                (() => {
                    ...
                    return [
                        ...
                        `sunk? ${(0, phone_chrome_ts_1.isViewportSunkBelowStatusBar)({

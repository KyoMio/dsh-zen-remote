...
function MobileHome({ useSessions, useWorkspaces, useStore, actions, openSession, startSession, t, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("div", { "data-mobile-nav": "home", "data-view": view, "aria-hidden": view === 'session', children: [(0, jsx_runtime_1.jsx)("div", { "data-mobile-nav": "home-top", children: (0, jsx_runtime_1.jsxs)("button", { type: "button", "data-mobile-nav": "ws-switch", "aria-haspopup": "menu", onClick: () => setSheet('filter'), children: [(0, jsx_runtime_1.jsx)("span", { children: title }), (0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.IconChevronDownOutline14, { size: 14 })] }) }), (0, jsx_runtime_1.jsxs)("ul", { "data-mobile-nav": "home-list", children: [rows.map((row) => {
                            ...
                            enter(() => startSession(selectedWorkspace?.workspaceId));
                                        ...
                                        }, children: item.title }, item.workspaceId)))] })] }))] }), view === 'session' && ((0, jsx_runtime_1.jsx)("button", { type: "button", "data-mobile-nav": "home-back", "aria-label": t('backToList'), title: t('backToList'), onClick: () => actions.show('home'), children: (0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.IconChevronLeftOutline14, { size: 14 }) }))] }));
}
};
 ...
 * composer → tablet → desktop), followed by the phone app shell (home),
 * which must come last so its <768px rules win ties against the shared
 * <=1023px block. Injected as ONE <style data-plugin> tag — do not reorder.
 */
exports.MOBILE_CSS = [base_css_ts_1.BASE_CSS, layout_css_ts_1.LAYOUT_CSS, compat_css_ts_1.COMPAT_CSS, misc_css_ts_1.MISC_CSS, home_css_ts_1.HOME_CSS].join('\n');
};

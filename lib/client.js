 ...
 */
exports.MOBILE_CSS = [base_css_ts_1.BASE_CSS, layout_css_ts_1.LAYOUT_CSS, compat_css_ts_1.COMPAT_CSS, misc_css_ts_1.MISC_CSS, home_css_ts_1.HOME_CSS, header_css_ts_1.HEADER_CSS, composer_css_ts_1.COMPOSER_CSS].join('\n');
};
...
function installDebugBadge(ctx) {
    ...
    ctx.effect(() => {
        ...
        const px = Number(raw);
        if (raw === null || !Number.isFinite(px))
            return () => { };

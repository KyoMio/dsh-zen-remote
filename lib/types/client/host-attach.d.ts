 ...
 */
export declare const HOST_ATTACH_INPUT = "[data-slot=\"conversation.composer.bar\"] [class$=\"_tools\"] > input[type=\"file\"]:not([data-mobile-nav])";
/** Synchronous read: does this host's composer ship its own attach picker? */
export declare function hostAttachPresent(): boolean;
/**
 ...
 */
export declare function useOwnAttachUi(): boolean;
//# sourceMappingURL=host-attach.d.ts.map
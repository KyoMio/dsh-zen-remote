...
export declare const SHARE_TURNS_PRESETS: readonly number[];
/**
...
export declare class ShareFetchError extends Error {
 ...
 */
export declare function buildShareExportQuery(session: string, range: ShareRange): string;
/**
 ...
 */
export declare function fetchShareExport(session: string, range: ShareRange): Promise<ShareExportData>;
//# sourceMappingURL=fetch-share.d.ts.map
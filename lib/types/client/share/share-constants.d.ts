...
export declare const BASE_CARD_WIDTH = 390;
/** Widened slice width for wide content (PLAN §5.2 “更大逻辑宽 ~780”). */
export declare const WIDE_SLICE_WIDTH = 780;
/**
 ...
 */
export declare const USER_BUBBLE_MAX_RATIO = 0.82;
/** Horizontal padding inside the user bubble (its `padding` X component). */
export declare const USER_BUBBLE_PAD_X = 14;
//# sourceMappingURL=share-constants.d.ts.map